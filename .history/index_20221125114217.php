...
<label for="my-modal-4" class="modal cursor-pointer">
  ...
  <form action="" method="POST">
              <button name="posts_query" class='btn bg-slate-100 text-black border-none' type="submit">Users</button>
              <button name="posts_query" class='btn bg-slate-100 text-black border-none' type="submit">Posts</button>
              <button class='btn' type="submit">Hey</button>
              <button class='btn' type="submit">Hey</button>
              <button class='btn' type="submit">Hey</button>
              <?php
                  if(true) {
