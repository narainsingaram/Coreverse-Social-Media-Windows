  ...
  <form action="index.php" method="POST" enctype="multipart/form-data">
    <div class="mb-4 w-full bg-gray-50 rounded-lg border border-gray-20">
        <div class="py-2 px-4 bg-white rounded-t-lg">
            ...
            <textarea name="post_text" id="comment" rows="4" class="px-0 focus-none outline-none w-full text-sm text-gray-900 bg-white border-0" placeholder="Write a comment..." required=""></textarea>
        </div>
