        ...
        <input type='text' id='myInput' contentEditable='true' value='http://localhost/demo/post.php?id=$id'>
				...
				<div class='card-body'>
				  ...
				  <div class='card-actions justify-end'>
					...
					<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none"><path opacity=".4" d="m7.11 5.961 9.02-3.01c4.05-1.35 6.25.86 4.91 4.91l-3.01 9.02c-2.02 6.07-5.34 6.07-7.36 0l-.89-2.68-2.68-.89c-6.06-2.01-6.06-5.32.01-7.35Z" fill="#FF8A65"></path><path d="m12.12 11.629 3.81-3.82ZM12.12 12.38c-.19 0-.38-.07-.53-.22a.754.754 0 0 1 0-1.06l3.8-3.82c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06l-3.8 3.82c-.15.14-.34.22-.53.22Z" fill="#FF8A65"></path></svg>
					</button>
				  </div>
				</div>
			  </div>			
