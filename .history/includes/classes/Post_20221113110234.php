        ...
        <input type='text' id='myInput' contentEditable='true' value='http://localhost/demo/post.php?id=$id'>
				...
				<div class='card-body'>
				  ...
				  <div class='card-actions justify-end'>
					...
					<iframe src='like.php?post_id=$id' class='btn btn-ghost bg-white h-30 w-20' scrolling='no'></iframe>
					<button class='btn bg-white btn-circle' name='comment-toggle-button' onClick='javascript:toggle$id()'> 
