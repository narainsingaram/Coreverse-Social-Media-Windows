        ...
        <input type='text' id='myInput' contentEditable='true' value='http://localhost/demo/post.php?id=$id'>
				...
				<div class='card-body'>
				  ...
				  <div class='card-actions justify-end'>
					...
					<iframe src='like.php?post_id=$id' class='bg-white h-20 w-20' scrolling='no'></iframe>
					<button class='btn bg-red-600 btn-circle' name='comment-toggle-button' onClick='javascript:toggle$id()'> 
