        ...
        <input type='text' id='myInput' contentEditable='true' value='http://localhost/demo/post.php?id=$id'>
				...
				<div class='px-3 py-2 '>
				  ...
				  <div class='flex p-0 justify-end'>
					...
					<label for='share_modal' class='bg-blue-100 hover:bg-blue-200 border-none btn btn-circle mx-1 mt-3.5'> 
					<svg xmlns='http://www.w3.org/2000/svg' width='32' height='32' viewBox='0 0 24 24' fill='none'>
			...
			<label for='share_modal' class='modal cursor-pointer'>
				<label class='modal-box bg-gray-800 z-80 relative'>
