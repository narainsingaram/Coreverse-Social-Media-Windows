        ...
        <input type='text' id='myInput' contentEditable='true' value='http://localhost/demo/post.php?id=$id'>
				...
				<div class='card-body'>
				  ...
				  <div class='card-actions justify-end'>
					...
					<iframe src='like.php?post_id=$id' class='bg-red-200 h-20 mb-12 w-20' scrolling='no'></iframe>
					<button class='btn btn-circle mt-5' name='comment-toggle-button' onClick='javascript:toggle$id()'> 
