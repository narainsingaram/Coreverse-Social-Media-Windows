        ...
        <input type='text' id='myInput' contentEditable='true' value='http://localhost/demo/post.php?id=$id'>
				...
				<div class='card-body'>
				  ...
				  <div class='card-actions justify-end'>
					...
					<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none"><path opacity=".4" d="M7 18.43h4l4.45 2.96a.997.997 0 0 0 
					1.55-.83v-2.13c3 0 5-2 5-5v-6c0-3-2-5-5-5H7c-3 0-5 2-5 5v6c0 3 2 5 5 5Z" fill="#FF8A65"></path>
					<path d="M15.5 11.25h-7c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h7c.41 0 .75.34.75.75s-.34.75-.75.75Z" fill="#FF8A65"></path></svg>
					</button>
				  </div>
				</div>
			  </div>			
