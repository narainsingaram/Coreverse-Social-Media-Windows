        ...
        <input type='text' id='myInput' contentEditable='true' value='http://localhost/demo/post.php?id=$id'>
				...
				<div class='px-3 py-2 '>
				  ...
				  <div class='flex p-0 justify-end'>
					...
					<button class='bg-teal-100 hover:bg-teal-200 border-none btn btn-circle mt-3.5' name='comment-toggle-button' onClick='javascript:toggle$id()'> 
					...
					<button class='bg-blue-100 hover:bg-blue-200 border-none btn btn-circle mx-2 mt-3.5'> 
					<svg xmlns='http://www.w3.org/2000/svg' width='32' height='32' viewBox='0 0 24 24' fill='none'>
