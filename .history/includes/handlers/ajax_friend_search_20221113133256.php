...
//If there are two words, assume they are first and last names respectively
	...
	$usersReturnedQuery = mysqli_query($con, "SELECT first_name,last_name,body FROM user, user_post WHERE (first_name LIKE '$names[0]%' AND last_name LIKE '$names[1]% AND') AND user_closed='no' LIMIT 8");
}
else if ($query == 'Posts') {
