        ...
        <div class="flex bg-slate-100 rounded-2xl justify-between items-center py-2 px-3">
            ...
            <input type="hidden" name="user_from" value="<?php echo $userLoggedIn; ?>">
              <input type="hidden" name="user_to" value="<?php echo $username;?>" >
                <input type="file" name="fileToUpload" id="fileToUpload" method="POST" class="hidden bg-red-200 inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                </input>
                <label for="fileToUpload">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none"><path opacity=".4" 
                d="m22.019 16.82-3.13-7.32c-.57-1.34-1.42-2.1-2.39-2.15-.96-.05-1.89.62-2.6 1.9l-1.9 3.41c-.4.72-.97 1.15-1.59 1.2-.63.06-1.26-.27-1.77-.92l-.22-.28c-.71-.89-1.59-1.32-2.49-1.23-.9.09-1.67.7
                1-2.18 1.72l-1.73 3.45c-.62 1.25-.56 2.7.17 3.88.73 1.18 2 1.89 3.39 1.89h12.76c1.34 0 2.59-.67 3.33-1.79.76-1.12.88-2.53.35-3.76Z" fill="#FF8A65"></path>
                <path d="M6.97 8.381a3.38 3.38 0 1 0 0-6.76 3.38 3.38 0 0 0 0 6.76Z" fill="#FF8A65"></path></svg>
                </label>
                #3b82f6
            </div>
        </div>
...
<label for="my-modal-4" class="modal cursor-pointer">
  ...
  <form action="" method="POST">
              <?php
                  if(true) {
                      ?>
                      <input class='w-full bg-slate-200 border-none outline-none rounded-xl px-4 py-3 my-2' type='text' onkeyup='getUsers(this.value, "<?php echo $userLoggedIn; ?>")' name='query' placeholder='Search friends to message' autocomplete='off' autofocus="autofocus" id='search_text_input'>
                      <hr class='my-2'>
                      <?php
