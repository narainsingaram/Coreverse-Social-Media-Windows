  ...
  <form action="index.php" method="POST" enctype="multipart/form-data">
    <div class="mb-4 w-full bg-gray-50 rounded-lg border border-gray-20">
        ...
        <div class="flex justify-between items-center py-2 px-3 border-t">
            <button type="submit" name="post" class="btn normal-case py-2 px-4 font-medium text-center text-white bg-blue-700 rounded-xl border-none focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800">
                Post comment
            </button>
