...
<label for="my-modal-4" class="modal cursor-pointer">
  ...
  <form action="" method="POST">
              <?php
                  if(true) {
                      ?>
                      <input class='w-full bg-slate-200 border-none outline-none rounded-xl px-4 py-2' type='text' onkeyup='getUsers(this.value, "<?php echo $userLoggedIn; ?>")' name='q' placeholder='Search friends to message' autocomplete='off' autofocus="autofocus" id='search_text_input'>
                      <?php
