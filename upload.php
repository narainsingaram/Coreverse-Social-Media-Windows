...
<div id="Overlay"></div>
	...
	<div class='upload_profile_pic_card'>
	<form action="upload.php" method="post" class='image_form' enctype="multipart/form-data">

			<img src='assets\images\upload_profile_pic.png' class='profile_upload_image_pic'> 
			<br>
			<br>
	        <input class="profile_image_upload_file_type_input" type="file" id="image" name="image" required/> 
			<label class='profile_image_upload_button' for="image"> <i class="uil uil-image-plus"></i> Select a profile photo</label> 
			<br>
	        <button class='submit_profile_pic_image'type="submit" value="Submit"> Next <i class="uil uil-arrow-right"></i></button>
	    </form>
                </div>
	        ...
	        <div id="InfoArea" style="width:180px; height:150px; position:relative; overflow:hidden; margin:40px 0px 0px 40px; border:0px #666 solid; float:left;"> 	
	           <p style="margin:0px; padding:0px; color:#444; font-size:18px;">          
	            ...
	            <form action="upload.php" method="post" onsubmit="return checkCoords();">
	                ...
	                <button type="submit" value="Save" class='save_profile_cropped_image_button'> Save </button>
	            </form>
	        </div>

	        <div id="CropImageForm2">  
	            <form action="upload.php" method="post" onsubmit="return cancelCrop();">
	                <button type="submit" value="Cancel Crop" class='cancel_profile_image_button'> Cancel </button>
	            </form>
	        </div>            
	           </p>
	        </div>  
